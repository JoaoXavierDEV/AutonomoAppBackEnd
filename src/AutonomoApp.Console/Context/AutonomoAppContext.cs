...
public class AutonomoAppContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //modelBuilder.Entity<Servico>().Ignore(x => x.Tags) ;

        // aplica as configurações mapping do namespace data.context
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(AutonomoApp.Data.Context.AutonomoAppContext).Assembly);
